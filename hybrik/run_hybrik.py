...
parser.add_argument("--save-pk", help="save prediction", action="store_true")
parser.add_argument("--save-img", help="save prediction", action="store_true")
...
for img_path in tqdm(img_path_list):
    ...
    if opt.save_pk:
        ...
        vertices = pose_output.pred_vertices.detach().cpu().data.numpy()
        faces = smplx_faces.cpu().data.numpy()

        res_db["vertices"].append(vertices)
        res_db["faces"].append(faces)
