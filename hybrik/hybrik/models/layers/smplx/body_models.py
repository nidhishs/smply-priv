...
from .lbs import (blend_shapes, find_dynamic_lmk_idx_and_bcoords, hybrik, lbs,
                  lbs_get_twist, mat2quat, vertices2landmarks)
from .utils import (Array, SMPLHOutput, SMPLOutput, SMPLXOutput, Struct,
                    Tensor, find_joint_kin_chain, to_np, to_tensor)
...
class SMPLXLayer(SMPLX):
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        lhand_filter_matrix = torch.matmul(
            left_hand_components.T, left_hand_components
        )  # 45x45
        rhand_filter_matrix = torch.matmul(
            right_hand_components.T, right_hand_components
        )  # 45x45
...
def build_layer(model_path: str, model_type: str = "smpl", **kwargs) -> SMPLXLayer:
